"""Sectioning helpers and slide-region data, copied verbatim from
aind-data-schema PR #1763 (`examples/procedures_sectioning.py`,
branch `1729-barseqmapseq-procedures`, author: Dan Birman).

Kept here so the capsule is self-contained and independent of the
example-file location in the schema repo (which Dan has indicated may
move out of `aind-data-schema`).
"""
